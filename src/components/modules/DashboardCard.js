...
const DashboardCard = ({ data }) => {
  ...
  return (
    <div className="w-[250px] mx-auto md:mx-0 sm:w-fit border-2 rounded-md p-2 border-[#BED7DC] hover:border-header-theme hover:shadow-lg transition-colors relative">
      {status === "waiting" && (
